...
import { X, Search, PlusCircle, Package, Truck, MessageCircle, Send, ShoppingBag } from "lucide-react";
      ...
      <div className="relative z-10 flex h-[85vh] w-full flex-col rounded-t-3xl bg-white pb-2 shadow-2xl dark:bg-slate-900 md:mx-auto md:h-[600px] md:max-w-md md:rounded-3xl">
        ...
        <div className="border-t border-slate-100 px-4 py-3 dark:border-slate-800">
          <div className="flex items-center gap-2">
            ...
            <button
              type="button"
              className="grid h-11 w-11 shrink-0 place-items-center rounded-full bg-gradient-to-br from-msm-blue to-violet-600 text-white shadow-md transition active:scale-90"
              aria-label="Enviar"
            >
              <Send size={16} />
            </button>

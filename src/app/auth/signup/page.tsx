...
export default async function SignupPage({ searchParams }: { searchParams: Promise<{ next?: string }> }) {
  ...
  return (
    <main className="min-h-screen bg-msm-midnight text-white">
      <section className="mx-auto grid min-h-screen max-w-6xl items-center gap-8 px-4 py-8 md:grid-cols-[1fr_0.9fr]">
        <div>
